...
实现接口:
- [SelectQueryInterface](../SelectQueryInterface)
...
## __construct($table, $alias, DatabaseConnection $connection, $options = array())
...
## havingCompile(DatabaseConnection $connection)
...
## havingExists(SelectQueryInterface $select)


## havingNotExists(SelectQueryInterface $select)
